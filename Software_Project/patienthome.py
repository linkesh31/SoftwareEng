...
# Image file path
image_path = "C:/Users/user/Documents/GitHub/SoftwareEng/Software_Project/"
...
search_view_clinic_img = load_image("search.png", button_size)
send_request_to_doctor_img = load_image("sendrequest.png", button_size)
