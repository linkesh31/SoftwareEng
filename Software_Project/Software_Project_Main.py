...
# Function to handle button click (dummy function for now)
...
def admin_login_clicked(event):
    # Code to handle admin login (e.g., open a new window or navigate to the next page)
    print("Admin login clicked")  # Placeholder action

def login_clicked(event):
    # Code to handle login (e.g., open a new window or navigate to the next page)
    print("Login clicked")  # Placeholder action
...
# Create a light blue background frame
top_frame = tk.Frame(root, bg="#ADD8E6", width=width, height=height)
top_frame.pack(fill="both", expand=True)

# Load and resize the logo image with rounded corners
image_path = "C:\\Users\\user\\Documents\\SEM 3\\Software Engineer\\Software_Project\\SoftwareLogo.png"
logo_image = create_rounded_image(image_path, (150, 150), 30)  # Adjust size and corner_radius as needed
...
logo_label.place(relx=1.0, rely=0.0, anchor="ne")  # Place at the top right corner

# Add text top left corner
...
# Doctor button image
doctor_image_path = "C:\\Users\\user\\Documents\\SEM 3\\Software Engineer\\Software_Project\\Doctor.png"
...
# Patient button image (assuming similar image)
patient_image_path = "C:\\Users\\user\\Documents\\SEM 3\\Software Engineer\\Software_Project\\Patient.png"
...
# Create the buttons with the rounded images
...
# Add text below the buttons using labels
...
# Frame for the login label and hyperlink
login_frame = tk.Frame(top_frame, bg="#ADD8E6")
login_frame.place(relx=0.99, rely=0.99, anchor="se")  # Adjust anchor and position to bottom right
